...
class Post extends StatelessWidget {
  ...
  final bool isImage;
  final bool? isImageHorizontalLong;
  final bool isMute;
                      ...
                      if (isImage)
                        Container(
                          ...
                          child: Stack(
                            children: [
                              Image.asset(
                                isImageHorizontalLong!
                                    ? 'assets/images/horizontal.png'
                                    : 'assets/images/vertical.jpg',
                                scale: isImageHorizontalLong! ? 16 / 9 : 9 / 16,
                              ),
                              if (isMute)
                                Positioned(
                                  bottom: 10,
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      borderRadius:
                                          BorderRadius.circular(Sizes.size100),
                                    ),
                                    child: Center(
                                      child: FaIcon(
